...
export default function About() {
  ...
  const journeyContent = [
    {
      header: t('about.section1.header'),
      text: t('about.section1.text'),
      position: 'left'
    },
    {
      header: t('about.section2.header'),
      text: t('about.section2.text'),
      position: 'right'
    },
    {
      header: t('about.section3.header'),
      text: t('about.section3.text'),
      position: 'left'
    },
    {
      header: t('about.section4.header'),
      text: t('about.section4.text'),
      position: 'right'
    },
  ];
  ...
  return (
    <section id="about" className="relative h-[400vh] w-full bg-black" ref={containerRef}>
          ...
          <div className="w-full h-full max-w-7xl mx-auto px-8 relative">
            {journeyContent.map((item, index) => {
              ...
              return (
                ...
                >
                  <h3 className="text-lg md:text-xl font-medium mb-3 text-gray-300/80 tracking-tight">
                    {item.header}
                  </h3>
